...
public class databasedoctruyen extends SQLiteOpenHelper {
    ...
    // biến lưu caai lệnh tạo bảng tài khoản
    ...
    // BIẾN LƯU CÂU LỆNH TẠO BẢNG TRUYÊN
    ...
    // INSERT DỮ LIỆU VÀO BẲNG
    // CHÚ Ý PHÂN QUYỀN : 1 ADIM VÀ 2. NGƯỜI DÙNG
    ...
    public int Update(Truyen truyen, int id){
        SQLiteDatabase db= this.getWritableDatabase();
        ...
        int res = db.update(TABLE_TRUYEN,  values,ID_TRUYEN+" ="+id,null);
        db.close();
        return res;
    }
}
